...
class Plugin(BasePlugin):
    ...
    def install(self):
        ...
        if os.path.isfile("/etc/yum.repos.d/_copr_youssefmsourani-sgvrecord.repo"):
            commands = ["dnf install {} -y --best".format(to_install)]
        else:
            commands = ["dnf copr enable youssefmsourani/sgvrecord -y","dnf install {} -y --best".format(to_install)]
